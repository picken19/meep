...
class MeepExampleApp(object):
	...
	def index(self, environ, start_response):
		...
		if user is None:
			...
			s =	 [
			"""%s logged in!<p>
			<a href='/m/add'>New Message</a><p>
			<a href='/create_user'>Create User</a><p>
			<a href='/logout'>Log out</a><p>
			<a href='/m/list'>Show messages</a>
			<form action='delete_all_messages_action' method='POST'> 
			<input type='submit' name='delete_all_messages_button' value='Delete all messages'></form><p>"""
			% (username,)]
